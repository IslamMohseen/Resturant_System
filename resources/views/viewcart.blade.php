...
<html lang="en">
  ...
  <head>
    ...
    <title>Miami Cafe - Restaurant</title>
<!--
...
-->
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="assets/images/klassy-logo.png" align="Miami cafe html template">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
    ...
    <div  id="top">
        <table align="center" style="background-color: yellowgreen" >
            <tr>
            ...
            <tr align="center">
              ...
              <td>
                <input type="text" name="quantaty[]" value="{{$cart->quantaty}}" hidden="">
                {{$cart->quantaty}}
            </td>
            </tr>
          @endforeach
            
          @foreach ($carts2 as $carts2)
            <tr style="position: relative; top: -105px; right: -390px">
                <td><a href="{{url('/removecart',$carts2->id)}}" >Remove</a></td>
            </tr>
